...
async function submitForm() {
  ...
  try {
    ...
    // Fully reload to clear current dashboard data and load new company
            ...
            <div v-if="currentStep === 1" key="step1" class="space-y-6">
              ...
              <div v-else class="space-y-5">
                ...
                <div v-if="searchMode === 'nom'" class="space-y-4">
                  <div class="space-y-2">
                    <Label for="searchNameNew" class="text-foreground font-medium">
                  ...
                  <div class="space-y-2">
                    <Label for="searchCPNew" class="text-foreground font-medium flex items-center justify-between">
                ...
                <div v-else-if="searchMode === 'siret'" class="space-y-4">
                  <div class="space-y-2">
                    <Label for="siretNew" class="text-foreground font-medium">
